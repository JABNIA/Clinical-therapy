  ...
  return (
    <HomeWrapper>
      ...
      <div>
        ...
        <img src="/src/assets/images/session.jpeg" alt="session" className="sessionImg"/>
      </div>
      </div>
...
//     Therapy can benefit anyone seeking change, clarity, or emotional support. A free initial consultation can help determine if we’re a good fit.

//     What can I expect in the first session?
//     We’ll discuss your goals, history, and concerns—no pressure to share everything at once.

//     Do you accept insurance?
//     [Explain insurance policies or sliding-scale options if applicable.]


// Headline: Therapeutic Services for Individuals and Couples

// Content:
// I provide personalized therapy for adults, adolescents, and couples, including:

//     Individual Therapy: Address anxiety, depression, stress, and self-esteem issues.

//     Trauma Therapy: Evidence-based treatments like EMDR or CPT for PTSD.

//     Couples Counseling: Improve communication and rebuild connection.

//     Specialized Approaches: CBT, DBT, psychodynamic therapy, and mindfulness.
